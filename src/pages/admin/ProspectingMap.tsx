...
export default function ProspectingMap() {
  ...
  const [center, setCenter] = useState({ lat: -23.55052, lng: -46.633308 });
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-1/3 bg-white border-r overflow-y-auto p-4 space-y-4 shadow-xl z-20">
          ...
          {places.map((place) => (
            <div
              key={place.place_id}
              className="p-4 border rounded-lg hover:border-indigo-300 hover:shadow-md transition-all bg-white group"
            >
