      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-8 rounded-xl shadow-lg text-white flex flex-col justify-center">
          <div className="mb-8 text-center">
            <p className="text-blue-100 text-sm uppercase tracking-wider font-semibold mb-2">
          ...
          <div className="space-y-4 border-t border-blue-500/30 pt-6">
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold text-lg">
                {(values.amount - values.downPayment).toLocaleString('pt-BR', {
                  style: 'currency',
                  currency: 'BRL',
                })}
              </span>
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold text-lg">
                {result.totalPayment.toLocaleString('pt-BR', {
                  style: 'currency',
                  currency: 'BRL',
                })}
              </span>
          ...
          <div className="mt-8 bg-white/10 p-4 rounded-lg text-sm text-blue-50">
            <p>
              * Simulação referencial (Tabela Price). Não inclui taxas administrativas, seguros ou
              IOF. Consulte seu banco para valores exatos.
            </p>
          </div>
        </div>
      </div>
