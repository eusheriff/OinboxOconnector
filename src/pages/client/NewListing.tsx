...
export default function NewListing() {
    ...
    const handleGenerateDescription = async () => {
        if (!formData.title || !formData.location) {
            alert('Preencha pelo menos o título e localização para gerar a descrição.');
            return;
        }
                    ...
                    <div className="flex items-center gap-4">
                        <label className="flex items-center gap-2 cursor-pointer">
                            <input
                                ...
                                onChange={(e) => setFormData(prev => ({...prev, publish_to_portals: e.target.checked}))}
                                className="w-5 h-5 text-primary rounded focus:ring-primary"
                            />
                            <span className="text-gray-700 font-medium">Publicar automaticamente nos portais (Zap/VivaReal/OLX)</span>
                        </label>
                    </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:bg-gray-50 transition-colors cursor-pointer">
                            ...
                            <p className="text-sm text-gray-600">Clique para fazer upload de fotos ou arraste aqui</p>
