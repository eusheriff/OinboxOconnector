...
export default function MarketingStudio() {
    ...
    const templates = [
        { id: '1', name: 'Story Moderno', type: 'Story', image: 'https://via.placeholder.com/300x533/e2e8f0/94a3b8?text=Story+Template+1' },
        { id: '2', name: 'Post Feed Clean', type: 'Feed', image: 'https://via.placeholder.com/400x400/e2e8f0/94a3b8?text=Feed+Template+1' },
        { id: '3', name: 'Destaque Venda', type: 'Story', image: 'https://via.placeholder.com/300x533/e2e8f0/94a3b8?text=Story+Template+2' },
        { id: '4', name: 'Carrossel Info', type: 'Feed', image: 'https://via.placeholder.com/400x400/e2e8f0/94a3b8?text=Feed+Template+2' },
    ];
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {templates.map((t) => (
                            <div
                                ...
                                className={`cursor-pointer rounded-xl overflow-hidden border-2 transition-all ${selectedTemplate === t.id ? 'border-blue-600 ring-2 ring-blue-100' : 'border-transparent hover:border-gray-200'
                                    }`}
                            >
                    ...
                    {selectedTemplate ? (
                        <div className="space-y-6 flex-1">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Selecionar Imóvel</label>
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Preço em Destaque</label>
                                    <input type="text" placeholder="R$ 500.000" className="w-full px-4 py-2 border border-gray-300 rounded-lg outline-none" />
                                </div>
                            </div>
