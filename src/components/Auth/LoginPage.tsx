      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center mb-8">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          {isClientMode
            ...
            : 'Gerencie sua imobiliÃ¡ria com IA'}
        </p>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-card text-muted-foreground">Ãrea do Cliente</span>
              </div>
            </div>
            ...
            <div className="mt-6 bg-blue-50 dark:bg-blue-950/30 p-4 rounded-lg border border-blue-100 dark:border-blue-900 flex gap-3 items-start">
              ...
              <div className="text-sm text-muted-foreground">
                <p className="font-bold text-foreground mb-1">NÃ£o tem acesso ainda?</p>
                <p>
                  VocÃª pode{' '}
                  <button
