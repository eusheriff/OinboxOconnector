...
const GlobalChatbot: React.FC = () => {
  ...
  const [messages, setMessages] = useState<{ role: 'user' | 'assistant'; text: string }[]>([
    {
      role: 'assistant',
      text: 'Olá! Sou a IA do Oinbox. Posso ajudar você a entender como nossa plataforma revoluciona vendas imobiliárias com inteligência artificial?',
    },
  ]);
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 w-[90vw] md:w-96 bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden animate-scale-in origin-bottom-right h-[500px]">
          ...
          <div className="p-3 bg-white border-t border-gray-100">
            ...
            <div className="text-[10px] text-center text-gray-400 mt-2">Powered by Oinbox AI</div>
          </div>
        </div>
      )}
