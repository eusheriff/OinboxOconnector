...
const LandingPage: React.FC<LandingPageProps> = ({ onNavigateLogin, onNavigateRegister }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-orange-100 selection:text-orange-900 overflow-x-hidden">
      {/* --- NAVBAR --- */}
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/80 backdrop-blur-md border-b border-slate-200 shadow-sm' : 'bg-transparent border-transparent'}`}
      >
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0 animate-fade-in-up delay-200">
                Conectamos sua carteira de <strong>Imóveis</strong> ao <strong>CRM</strong> através
                de uma <strong>IA</strong> que conversa, qualifica e fecha vendas sozinha.
              </p>
            ...
            <div className="flex-1 w-full max-w-[600px] h-[500px] relative flex items-center justify-center">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[280px] h-[280px] animate-spin-slow">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-6 w-16 h-16 bg-white rounded-2xl shadow-lg border border-slate-100 flex items-center justify-center animate-spin-reverse-self">
                  ...
                  <div className="absolute -bottom-6 text-[10px] font-bold text-slate-400 bg-white px-2 py-0.5 rounded shadow-sm">
                    Imóveis
                  </div>
                </div>
              </div>
              ...
              <div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[280px] h-[280px] animate-spin-slow"
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-xl text-slate-500">
              Tudo o que você precisa para gerir sua imobiliária, do lead ao fechamento, em uma
              interface solar e intuitiva.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100 hover:shadow-lg hover:shadow-orange-500/5 transition-all group">
              ...
              <p className="text-slate-600 leading-relaxed">
                Chega de trocar de celular. Atenda WhatsApp, Instagram e Facebook em uma única tela
                organizada por funil.
              </p>
            </div>
            ...
            <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100 hover:shadow-lg hover:shadow-orange-500/5 transition-all group">
              ...
              <p className="text-slate-600 leading-relaxed">
                Nossa IA qualifica leads 24h por dia, agenda visitas e responde dúvidas sobre
                imóveis com precisão humana.
              </p>
            </div>
            ...
            <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100 hover:shadow-lg hover:shadow-orange-500/5 transition-all group">
              ...
              <p className="text-slate-600 leading-relaxed">
                Crie campanhas de alta conversão para Instagram e Google em segundos. A IA escreve a
                copy e escolhe a imagem.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {plans.map((plan, i) => (
              <div
                key={i}
                className={`relative bg-white rounded-3xl p-8 border ${plan.highlight ? 'border-orange-500 shadow-2xl shadow-orange-500/10 scale-105 z-10' : 'border-slate-200 shadow-xl shadow-slate-200/50'} flex flex-col`}
              >
                {plan.highlight && (
            ...
            {[
              {
                ...
                a: 'Não. Você pode começar com o plano Grátis sem cadastrar cartão.',
              },
              {
                q: 'A IA substitui o corretor?',
                a: 'Não. Ela potencializa o corretor, filtrando curiosos e agendando visitas reais.',
              },
              {
                q: 'Posso cancelar quando quiser?',
                a: 'Sim. Sem multas ou fidelidade nos planos mensais.',
              },
            ].map((item, i) => (
              <div key={i} className="border border-slate-200 rounded-2xl overflow-hidden">
                ...
                >
                  ...
                  <ChevronDown
                    className={`text-slate-400 transition-transform ${openFaqIndex === i ? 'rotate-180' : ''}`}
                  />
                </button>
                {openFaqIndex === i && (
