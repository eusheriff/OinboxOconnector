...
const PropertyMap: React.FC = () => {
  ...
  const [locationInfo, setLocationInfo] = useState<{text: string, sources: GroundingSource[]} | null>(null);
    ...
    <div className="flex-1 relative h-full bg-slate-100 overflow-hidden">
      ...
      <div className="w-full h-full relative bg-[#e5e7eb] group cursor-grab active:cursor-grabbing">
        ...
        <div 
            ...
            style={{ 
                backgroundImage: 'url("https://img.freepik.com/free-vector/city-map-abstract-background_23-2148303626.jpg?w=2000")',
           ...
           <div className="p-6 flex-1 overflow-y-auto">
              ...
              <div className="bg-indigo-50 rounded-xl p-4 border border-indigo-100">
                 <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="font-bold text-indigo-900 text-sm">Raio-X da Região (Google Maps)</h3>
                 </div>

                 {!locationInfo ? (
                    <div className="text-center py-2">
                        <p className="text-xs text-indigo-700 mb-3">Descubra o que há de bom ao redor deste imóvel usando dados reais do Google Maps.</p>
                        <button 
                    ...
                    <div className="space-y-3 animate-fade-in">
                        ...
                        {locationInfo.sources.length > 0 && (
                            <div>
                                <p className="text-[10px] font-bold text-indigo-400 uppercase mb-1">Locais Encontrados:</p>
