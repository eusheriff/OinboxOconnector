...
import { Calculator, DollarSign, Calendar, PieChart, Share2, RefreshCw, Building2, TrendingUp, CheckCircle2, AlertTriangle, Landmark, ArrowRight } from 'lucide-react';
...
const BANKS: BankOption[] = [
  ...
  { id: 'bb', name: 'Banco do Brasil', color: 'text-yellow-600', logoBg: 'bg-yellow-100', baseRate: 9.80, adminFee: 0, insuranceRate: 0.036 },
];
...
const FinancialCalculator: React.FC = () => {
  ...
  const calculateLoan = () => {
    ...
    setTimeout(() => {
        ...
        const firstInsurance = loanAmount * (bank.insuranceRate / 100); // Est. Seguro
        const firstInstallment = amortization + firstInterest + firstInsurance + bank.adminFee;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-indigo-50 border border-indigo-100 p-4 rounded-xl flex gap-3">
                ...
                <div>
                    <p className="text-xs font-bold text-indigo-800 uppercase mb-1">Dica do Especialista</p>
                    <p className="text-sm text-indigo-700 leading-snug">
                        A Selic está em {MARKET_INDICES.selic}%. A Caixa Econômica costuma ter as melhores taxas para primeiro imóvel via SFH.
                    </p>
                </div>
            </div>
          </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden transition-all relative">
                ...
                <div className="p-6 md:p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center px-2">
                                ...
                                <span className="font-bold text-slate-700">R$ {result.lastInstallment.toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                                <p className="text-xs font-bold text-gray-500 uppercase mb-1">Renda Familiar Exigida</p>
                                <p className="text-2xl font-bold text-slate-700">
                                    R$ {result.requiredIncome.toLocaleString('pt-BR', {minimumFractionDigits: 2})}
                                </p>
                    ...
                    <p className="text-[10px] text-center text-gray-400 mt-6 max-w-lg mx-auto">
                        * Simulação baseada em tabelas vigentes (SAC-TR). Inclui estimativa de Seguros (MIP/DFI) e Taxa Adm. 
                        Sujeito a análise de crédito e aprovação da instituição financeira. Valores informativos.
                    </p>
                </div>
              </div>
            )}
