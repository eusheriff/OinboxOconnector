    ...
    <div className="min-h-screen bg-slate-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center mb-8">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Já tem credenciais? <button onClick={onSwitchToLogin} className="font-medium text-primary hover:text-blue-500">Fazer Login</button>
        </p>
      </div>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-xl shadow-slate-200 sm:rounded-xl sm:px-10 border border-gray-200">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block text-xs font-bold text-foreground uppercase mb-1">Nome Completo</label>
            ...
            <div>
              <label className="block text-xs font-bold text-foreground uppercase mb-1">Nome da Imobiliária</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div>
              <label className="block text-xs font-bold text-foreground uppercase mb-1">Email Corporativo</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div>
              <label className="block text-xs font-bold text-foreground uppercase mb-1">WhatsApp / Celular</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
