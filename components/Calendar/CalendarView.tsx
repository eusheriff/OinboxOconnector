                ...
                <div className="lg:col-span-4 space-y-6">
                    <div className="bg-card rounded-2xl p-6 shadow-sm border section-border">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="font-bold text-foreground">{new Date().toLocaleDateString('pt-BR', { month: 'long', year: 'numeric' })}</h3>
                        ...
                        <div className="grid grid-cols-7 gap-1 text-center text-sm mb-2">
                            {['D','S','T','Q','Q','S','S'].map((d, i) => <span key={i} className="text-muted-foreground text-xs font-bold py-2">{d}</span>)}
                        </div>
                            ...
                            {Array.from({length: 31}, (_, i) => (
                                <button 
                                    ...
                                    className={`p-2 rounded-lg text-sm font-medium transition-all ${
                                        i+1 === new Date().getDate() ? 'bg-primary text-primary-foreground shadow-md' : 'hover:bg-accent text-foreground'
                                    }`}
                                >
                                    {i + 1}
                                </button>
                            ...
                            <div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex -space-x-2">
                                        <div className="w-8 h-8 rounded-full bg-card border-2 border-blue-50 flex items-center justify-center text-xs font-bold text-muted-foreground">RS</div>
                                    </div>
