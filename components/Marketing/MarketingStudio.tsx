...
import { Instagram, Download, Palette, Type, Sparkles, Image as ImageIcon, Layout, Loader2 } from 'lucide-react';
...
const TEMPLATES: MarketingTemplate[] = [
    ...
    { id: 't2', name: 'Stories - Oportunidade', format: 'story', label: 'OPORTUNIDADE', color: 'bg-primary' },
...
const MarketingStudio: React.FC = () => {
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            alert("Erro ao gerar imagem. Verifique se a imagem do imóvel permite CORS (Cloudflare R2 configurado).");
        }
    };
    ...
    if (!selectedProperty) {
        return (
            <div className="flex flex-col items-center justify-center h-full text-gray-500">
                ...
                <p>Nenhum imóvel encontrado. Cadastre um imóvel primeiro.</p>
            </div>
        );
    }
        ...
        <div className="flex-1 bg-gray-50 p-4 md:p-8 overflow-y-auto h-full">
            <div className="max-w-6xl mx-auto h-full flex flex-col">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-muted-foreground">Crie posts profissionais para redes sociais instantaneamente usando os dados dos seus imóveis.</p>
                </div>
                        ...
                        <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
                            ...
                            <div className="space-y-2 max-h-48 overflow-y-auto pr-1 custom-scrollbar">
                                {properties.map(prop => (
                                    ...
                                    >
                                        <img src={prop.image || 'https://via.placeholder.com/150'} className="w-10 h-10 rounded object-cover" alt="" />
